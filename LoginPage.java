...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setForeground(new java.awt.Color(23, 120, 240));
        jLabel1.setText("employeeDB");

        jLabel2.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        jLabel2.setText("Store your employees' data easily.");

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/accent.png"))); // NOI18N
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        try
        {
            ...
            if (txtUsername.getText().equals("") || txtPassword.getText().equals("")) {
                ...
                // checks if username and password match in users table
                if (rs.next()) {
                    ...
                    if (rs1.next()) {
                        this.setVisible(false);
                        new HomePage(username).setVisible(true); // pass the username into HomePage.java (this will be the table name)
                    } else {
                    ...
                    JOptionPane.showMessageDialog(null, "User doesn't exist. Please sign up.");
